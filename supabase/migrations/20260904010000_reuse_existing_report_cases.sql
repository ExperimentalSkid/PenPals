-- A report trigger and the existing report-case trigger can run in either
-- order.  Reuse an open case for the same target so preserved-content scans
-- never create a duplicate moderation case.
