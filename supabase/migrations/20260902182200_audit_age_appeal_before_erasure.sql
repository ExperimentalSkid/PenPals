-- Write the audit event before approval removes the restricted identity.  The
-- existing target_user_id foreign key then safely nulls the deleted target.
...
begin
  ...
  if decision = 'approved' then
    ...
    -- approval lets the person retry signup normally without creating one.
