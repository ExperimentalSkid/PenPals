-- Accept punctuation attached to words while counting only whitespace-separated
-- tokens that contain at least one alphanumeric character. This preserves the
-- 50-500 character and eight-word rules without allowing punctuation padding to
-- satisfy the word minimum.
