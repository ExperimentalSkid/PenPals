-- Keep cancelled Snail Mail out of the delivered/read transition as well as
-- out of the normal delivery worker.  This is an incremental follow-up so
-- already-applied cancellation migrations are never rewritten in production.
...
begin
  ...
  update public.snail_mail_letters
   ...
   where id = letter_id and recipient_id = me and cancelled_at is null;
end;
$$;
